...
export default async function BlogPage() {
  ...
  <h1
    className="text-5xl pt-3 font-extrabold text-center tracking-tight text-white drop-shadow-sm"
  >
    Insights & Stories
  </h1>
  <p className="text-2xl text-center pt-2 text-gray-400">
    Discover the latest insights and stories from our community.
  </p>

  {/* Responsive Grid for Articles */}
  <div className="grid grid-cols-1 pt-20 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-2 gap-16">
...
>
  ...
  {/* CTA */}
  <span
    className="mt-8 inline-block self-start text-base md:text-lg font-semibold 
